...
<div class="container">
	<div class="row header">
		<div class="logo navbar-left">
			<h1><a href="index.html">AL-ARABY SCHOOL</a></h1>
		</div>
		...
		<nav class="navbar navbar-default navbar-left" role="navigation">
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      <ul class="nav navbar-nav">
		        ...
		        <li><a href="index.php">Technologies</a></li>
			    ...
			    <div class="col-md-4 company_ad">
				    <h2>find Address :</h2>
      				<address>
						 ...
						 <p>Kafr-Elzayat,</p>
						 <p>USA</p>
				   		<p>Phone:(+2) 1285874193</p>
				   		<p>Fax: (+2) 1091156413</p>
				 	 	<p>Email: <a href="mailto:Hossamhatia1@gmail.com">info(at)Yat.com</a></p>
				   		<p>Follow on: <a href="www.facebook.om">Facebook</a>, <a href="www.twitter.com">Twitter</a></p>
				   	</address>
				</div>
				<div class="col-md-8">
